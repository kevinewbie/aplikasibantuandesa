...
<html>
    <head>
        ...
        <title>Desa Alang Kepayang</title>
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="<?php echo base_url(); ?>/adminlte/index2.html"><b>Sistem Desa Alang Kepayang </br>
				<img src='http://localhost/bdesa/assets/logo-desa.png' alt='photo of me' /></b> </a>
