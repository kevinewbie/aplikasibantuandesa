...
<html>
    <head>
        ...
        <title>SISTEM BANTUAN DESA ALANG KEPAYANG</title>
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="<?php echo base_url() ?>adminlte/index2.html" class="logo">
                    ...
                    <span class="logo-mini"><b>       <img src="http://localhost/bdesa/assets/foto_profil/Untitled-5.gif"></b></span>
                    <!-- logo for regular state and mobile devices -->
                    <img src="http://localhost/bdesa/assets/foto_profil/Untitled-3.gif">
                </a>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>
                                            ...
                                            <small>Sistem Desa Alang Kepayang</small>
                                        </p>
                                    </li>
                                    <!-- Menu Footer-->
